	...
	<div class="col-lg-6" align="center">
		...
		<input type="hidden" name="act" id="act">
			...
			<div class="form-group" align="left">
				...
				<input type="password" class="form-control" id="pwdcheck" name="pwdcheck" placeholder="비밀번호를 다시 한 번 입력하세요.">
			</div>
			<div class="form-group" align="left">
				<label for="email">이메일</label><br>
				<div id="email" name="email" class="custom-control-inline">
				<input type="text" class="form-control" id="emailid" name="emailid" placeholder="example@gmail.com" size="25"> @
